...
<head>
    ...
    <title>Update Schedule — YatraGo Admin</title>
...
<main>
    <div class="admin-content">
        ...
        <div class="admin-page-header">
            <div>
                <h1 class="admin-page-title">Update Schedule</h1>
                <p class="admin-page-subtitle">Editing schedule #${schedule.id}</p>
            </div>
        ...
        <div class="form-card">
            ...
            <form action="${pageContext.request.contextPath}/admin/update-schedule" method="post" novalidate id="updateScheduleForm">
                    ...
                    <div class="form-group">
                        ...
                        <select id="busId" name="busId" class="form-input" required>
                            ...
                            <c:forEach var="bus" items="${buses}">
                                <option value="${bus.id}" ${schedule.busId == bus.id ? 'selected' : ''}>${bus.busNumber} &middot; ${bus.operatorName}</option>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select id="routeId" name="routeId" class="form-input" required>
                            ...
                            <c:forEach var="route" items="${routes}">
                                <option value="${route.id}" ${schedule.routeId == route.id ? 'selected' : ''}>${route.origin} &rarr; ${route.destination}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" id="journeyDate" name="journeyDate" class="form-input"
                               value="${schedule.journeyDate}" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="time" id="departureTime" name="departureTime" class="form-input"
                               value="${schedule.departureTime}" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="arrivalTime">Arrival Time *</label>
                        <input type="time" id="arrivalTime" name="arrivalTime" class="form-input"
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="fare" name="fare" class="form-input"
                               value="${schedule.fare}" step="0.01" min="0" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" id="availableSeats" name="availableSeats" class="form-input"
                               value="${schedule.availableSeats}" min="0" required>
                    </div>
                </div>
