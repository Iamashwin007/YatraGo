...
<main class="subpage-main">
    ...
    <section class="subpage-section soft-section">
        <div class="container">
            ...
            <div class="team-grid">
                <article class="team-card"><div class="avatar">AM</div><h4>Anuska Magar</h4><p>Authentication &amp; Security Developer</p></article>
                <article class="team-card"><div class="avatar">AP</div><h4>Ashwin Pokhrel</h4><p>Team Lead &amp; Frontend Developer</p></article>
                <article class="team-card"><div class="avatar">AJ</div><h4>Ashutosh Janga Thapa</h4><p>Schedule &amp; Booking Backend Developer</p></article>
                <article class="team-card"><div class="avatar">HB</div><h4>Hritika Biswakarma</h4><p>Admin Dashboard &amp; Bus Management</p></article>
                <article class="team-card"><div class="avatar">JK</div><h4>Jonrika Karki</h4><p>Database &amp; Route Management</p></article>
                <article class="team-card"><div class="avatar">NR</div><h4>Nisha Rai</h4><p>User/Driver Models &amp; Analytics</p></article>
            </div>
        </div>
    </section>
</main>
